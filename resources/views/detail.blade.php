      ...
      function initMap() {
        ...
        if (navigator.geolocation) {
          navigator.geolocation.getCurrentPosition(function(position) {
            ...
            infoWindow.setContent('ABC Music Festival.');
            infoWindow.open(map);
            map.setCenter(pos);
          }, function() {
      ...
      function handleLocationError(browserHasGeolocation, infoWindow, pos) {
        ...
        */
        ...
        <!-- Google Map End -->
                ...
                <div class="group-info field-group-div" style="border: 1px solid black">
                    <div class="field field-name-field-location-taxonomize-terms">Waterloo, Ontario, Canada</div>
                    <div class="field field-name-host-verification">      
                        ...
                        <div class="verification">
                            ...
                            <span class="verify-text"> ID</span>
                        </div>
                        </a>
                        <br>
                    </div>
        ...
        <div class="col-lg-9 top-space">
            <div class="mt-5 ">

                <div class="detail-top-img">
                    <img src="https://media.stubhubstatic.com/stubhub-catalog/d_defaultLogo.jpg/t_f-fs-0fv,q_auto:low,f_auto,c_fill,dpr_2.0,$w_750,$h_416/grouping/1498494/b7a1854668a06c4df3f7b23ec783588f" alt="">
                </div>
                <ul class="nav nav-tabs mt-3">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#loc">Location</a>
                    </li>
                    <li class="nav-item">
